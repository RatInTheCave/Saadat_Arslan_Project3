package Part3_Improved_Conversation;

import java.util.Scanner;

public class MoviesConversation {
    public static void main(String[] args) {
        ...
        if (recommendation.equals("Animated films")) {
            if (PreferredGenreFlag == 0) {
                ...
                if (age < 16) {
                    System.out.println(name + " since you like live-action films, and you like fantasy movies, I would recommend ''Harry Potter and the Sorcerer's stone''");
                } else {
